...
// Remember that:
// (1) The vertices for each triangle has to be provided in a counter-clockwise order
// to make the face culling work properly.
// If the order of vertices won't be correct the triangles won't be visible.
